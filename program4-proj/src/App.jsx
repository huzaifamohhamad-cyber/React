...
const App = () => {
  ...
  const jobOpenings = [
    ...
    {
      brandLogo: "https://images.search.yahoo.com/search/images;_ylt=AwrKDcwChTVqLQIA_geJzbkF;_ylu=Y29sbwNzZzMEcG9zAzgEdnRpZAMEc2VjA3Ny?fr=mcafee&p=google+logo&imgurl=https%3A%2F%2Fstatic.vecteezy.com%2Fsystem%2Fresources%2Fpreviews%2F046%2F861%2F647%2Fnon_2x%2Fgoogle-logo-transparent-background-free-png.png",
      companyName: "Google",
