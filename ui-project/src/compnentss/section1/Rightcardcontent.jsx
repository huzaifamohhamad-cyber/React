...
const Rightcardcontent = (props) => {
  ...
  //           <h2 className='bg-white font-bold text-2xl rounded-full h-12 w-12 flex justify-center items-center'>{props.id+1}</h2>
  //           <div>
  //           <p className='text-shadow-2xs text-xl leading-relaxed text-white mb-14'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nesciunt, nobis!</p>
